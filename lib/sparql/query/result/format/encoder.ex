defmodule SPARQL.Query.Result.Format.Encoder do
  @moduledoc """
  A behaviour for encoders of `SPARQL.Query.ResultSet`s in a specific `SPARQL.Query.Result.Format`s.
  """
  ...
  `SPARQL.Query.ResultSet`, or `{:error, reason}` if an error occurs.
  """
  @callback encode(SPARQL.Query.ResultSet.t, keyword) :: keyword(String.t)
  ...
  """
  @callback encode!(SPARQL.Query.ResultSet.t, keyword) :: String.t
